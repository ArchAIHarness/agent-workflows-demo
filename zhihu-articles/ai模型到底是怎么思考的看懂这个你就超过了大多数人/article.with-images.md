...
![AI 模型根据上下文预测下一个片段](illustrations/02-super-speaker-next-token.png)
...
![模型通过训练和反馈学习语言规律](illustrations/03-training-feedback-loop.png)
...
![AI 幻觉需要人工验证关键信息](illustrations/04-ai-hallucination-verification.png)
